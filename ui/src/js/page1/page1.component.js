            ...
            "controller": ['$http', '$scope', '$rootScope', '$state', '$q', '$compile',
                ...
                function ($http, $scope, $rootScope, $state, $q, $compile) {
                    ...
                    self.add_loader = function () {
                        ...
                        $('.widget-88a').addClass('widget-loader-show');
                        $('.widget-88b').addClass('widget-data-hide');
                        $('.widget-89a').addClass('widget-loader-show');
                        $('.widget-89b').addClass('widget-data-hide');
                        $('.widget-90a').addClass('widget-loader-show');
                        $('.widget-90b').addClass('widget-data-hide');
                        $('.widget-91a').addClass('widget-loader-show');
                        ...
                        $('.widget-94a').addClass('widget-loader-show');
                        $('.widget-94b').addClass('widget-data-hide');
                        $('.widget-95a').addClass('widget-loader-show');
                        $('.widget-95b').addClass('widget-data-hide');
                        $('.widget-96a').addClass('widget-loader-show');
                        $('.widget-96b').addClass('widget-data-hide');
                        $('.widget-97a').addClass('widget-loader-show');
                        ...
                        $('.widget-101a').addClass('widget-loader-show');
                        $('.widget-101b').addClass('widget-data-hide');
                        $('.widget-102a').addClass('widget-loader-show');
                        $('.widget-102b').addClass('widget-data-hide');
                        $('.widget-103a').addClass('widget-loader-show');
                        $('.widget-103b').addClass('widget-data-hide');
                        $('.widget-104a').addClass('widget-loader-show');
                        $('.widget-104b').addClass('widget-data-hide');

                    }

                    self.apply_class = function () {

                        if ((self.day_type === 'hour') || (self.sel_type === 'hour')) {
                    ...
                    self.checkpoint = function(from,to){
                    ...
                    self.main_widget_function = function (callback, packet) {
                        ...
                        self.Volume_Comparison_id = function (final_work, type) {
                            ...
                            var volume_comp_id = '/api/volume_comp_id/' + self.data_to_show + type + final_work + '&chart_name=80';

                            return $http({ method: "GET", url: volume_comp_id }).success(function (result) {

                                var date_list = result.result.date;
                                var volume_comp_id = result.result.volume_comp_id;
                                var is_annotation = result.result.is_annotation;



                                if (self.list_object.volume_comparison_id != undefined) {

                                    if (self.list_object.volume_comparison_id.display_value === true) {
                                ...
                                if (self.list_object.volume_comparison_id != undefined) {
                                    ...
                                    if (self.list_object.volume_comparison_id.legends_align == 'bottom') {
                                    ...
                                    else if (self.list_object.volume_comparison_id.legends_align == 'left') {
                                ...
                                angular.extend(self.chartOptions85, {
                                        ...
                                        series: {
                                            ...
                                            events: {
                                                hide: function () {
                                                    var name = this.name;
                                                    var visibility = this.visible;
                                                    var chart_name = self.cust_volume_id_lst;
                                                    if (self.annotation) {
                                                        if (chart_name.indexOf(name) >= 0) {
                                    ...
                                    series: volume_comp_id,
                                    onComplete: function (chart) {
                                        if (is_annotation) {
                                            var series = null;
                                            var chart_data = chart.series;
                                            self.annotation = [];
                                            self.cust_volume_id_lst = [];
                                            for (var i in chart_data) {
                                                series = chart_data[i];
                                                (function (series) {
                                                    $http({
                                                        ...
                                                        $.each(annotations, function (j, annotation) {
                                                            ...
                                                            if (annotation.epoch) {
                                                                ...
                                                                self.cust_volume_id_lst.push(series.name);
                                                                self.annot_perm();
                                                            }
                                                        })
                        ...
                        self.Volume_Comparison_identity = function (final_work, type) {
                            ...
                            var comp_volume_identity = '/api/comp_volume_identity/' + self.data_to_show + type + final_work + '&chart_name=81';

                            return $http({ method: "GET", url: comp_volume_identity }).success(function (result) {

                                var date_list = result.result.date;
                                var comp_volume_identity = result.result.comp_volume_identity;
                                var is_annotation = result.result.is_annotation;



                                if (self.list_object.volume_comparison_identity != undefined) {

                                    if (self.list_object.volume_comparison_identity.display_value === true) {
                                ...
                                if (self.list_object.volume_comparison_identity != undefined) {
                                    ...
                                    if (self.list_object.volume_comparison_identity.legends_align == 'bottom') {
                                    ...
                                    else if (self.list_object.volume_comparison_identity.legends_align == 'left') {
                                ...
                                angular.extend(self.chartOptions86, {
                                        ...
                                        series: {
                                            ...
                                            events: {
                                                hide: function () {
                                                    var name = this.name;
                                                    var visibility = this.visible;
                                                    var chart_name = self.cust_volume_identity_lst;
                                                    if (self.annotation) {
                                                        if (chart_name.indexOf(name) >= 0) {
                                                            self.annotation.forEach(function (value_data) {
                                                                value_data.redraw(name, visibility);
                                                            });
                                                            $(document).find('.widget-81a').children(".widget-81b").find('.annotation-marker[series-name="' + name + '"]').css("opacity", 0);
                                                        }
                                                    }
                                                },
                                                show: function () {
                                                    ...
                                                    if (self.annotation) {
                                                        if (chart_name.indexOf(name) >= 0) {
                                                            ...
                                                            $(document).find('.widget-81a').children(".widget-81b").find('.annotation-marker[series-name="' + name + '"]').css("opacity", 1);
                                                        }
                                                    }
                                                }
                                            }
                                    ...
                                    series: comp_volume_identity,
                                    onComplete: function (chart) {
                                        if (is_annotation) {
                                            var series = null;
                                            var chart_data = chart.series;
                                            self.annotation = [];
                                            self.cust_volume_identity_lst = [];
                                            for (var i in chart_data) {
                                                series = chart_data[i];
                                                (function (series) {
                                                    $http({
                                                        ...
                                                        $.each(annotations, function (j, annotation) {
                                                            ...
                                                            if (annotation.epoch) {
                                                                ...
                                                                window.annotation = a;
                                                                self.annotation.push(a);
                                                                self.cust_volume_identity_lst.push(series.name);
                                                                self.annot_perm();
                                                            }
                                                        })
                        ...
                        self.AHT_Comparison_id = function (final_work, type) {
                            ...
                            var aht_comp_id = '/api/aht_comp_id/' + self.data_to_show + type + final_work + '&chart_name=82';

                            return $http({ method: "GET", url: aht_comp_id }).success(function (result) {

                                var date_list = result.result.date;
                                var aht_comp_id = result.result.aht_comp_id;
                                var is_annotation = result.result.is_annotation;

                                if (self.list_object.aht_comparison_id != undefined) {

                                    if (self.list_object.aht_comparison_id.display_value === true) {
                                ...
                                if (self.list_object.aht_comparison_id != undefined) {
                                    ...
                                    if (self.list_object.aht_comparison_id.legends_align == 'bottom') {
                                    ...
                                    else if (self.list_object.aht_comparison_id.legends_align == 'left') {
                                        ...
                                        series: {
                                            ...
                                            events: {
                                                hide: function () {
                                                    var name = this.name;
                                                    var visibility = this.visible;
                                                    var chart_name = self.cust_aht_id_lst;
                                                    if (self.annotation) {
                                                        if (chart_name.indexOf(name) >= 0) {
                                                            self.annotation.forEach(function (value_data) {
                                                                value_data.redraw(name, visibility);
                                                    ...
                                                    $http({
                                                        ...
                                                        $.each(annotations, function (j, annotation) {
                                                            ...
                                                            if (annotation.epoch) {
                                                                ...
                                                                window.annotation = a;
                                                                self.annotation.push(a);
                                                                self.cust_aht_id_lst.push(series.name);
                                                                self.annot_perm();
                                                            }
                                                        })
                        ...
                        self.AHT_Comparison_identity = function (final_work, type) {
                            ...
                            var identity_aht_comp = '/api/identity_aht_comp/' + self.data_to_show + type + final_work + '&chart_name=83';

                            return $http({ method: "GET", url: identity_aht_comp }).success(function (result) {

                                var date_list = result.result.date;
                                var identity_aht_comp = result.result.identity_aht_comp;
                                var is_annotation = result.result.is_annotation;



                                if (self.list_object.aht_comparison_identity != undefined) {

                                    if (self.list_object.aht_comparison_identity.display_value === true) {
                                ...
                                if (self.list_object.aht_comparison_identity != undefined) {
                                    ...
                                    if (self.list_object.aht_comparison_identity.legends_align == 'bottom') {
                                    ...
                                    else if (self.list_object.aht_comparison_identity.legends_align == 'left') {
                                ...
                                angular.extend(self.chartOptions88, {
                                        ...
                                        series: {
                                            ...
                                            events: {
                                                hide: function () {
                                                    var name = this.name;
                                                    var visibility = this.visible;
                                                    var chart_name = self.cust_aht_identity_lst;
                                                    if (self.annotation) {
                                                        if (chart_name.indexOf(name) >= 0) {
                                                            self.annotation.forEach(function (value_data) {
                                                                value_data.redraw(name, visibility);
                                    ...
                                    series: identity_aht_comp,
                                    onComplete: function (chart) {
                                        if (is_annotation) {
                                            var series = null;
                                            var chart_data = chart.series;
                                            self.annotation = [];
                                            self.cust_aht_identity_lst = [];
                                            for (var i in chart_data) {
                                                series = chart_data[i];
                                                (function (series) {
                                                    $http({
                                                        ...
                                                        $.each(annotations, function (j, annotation) {
                                                            ...
                                                            if (annotation.epoch) {
                                                                ...
                                                                window.annotation = a;
                                                                self.annotation.push(a);
                                                                self.cust_aht_identity_lst.push(series.name);
                                                                self.annot_perm();
                                                            }
                                                        })
                        ...
                        self.Time_Ready_Busy_Percentage = function (final_work, type) {
                            ...
                            var cust_busy_ready = '/api/cust_busy_ready_percentage/' + self.data_to_show + type + final_work + '&chart_name=84';

                            return $http({ method: "GET", url: cust_busy_ready }).success(function (result) {

                                var date_list = result.result.date;
                                var custo_busy_ready = result.result.custo_time_ready_busy;
                                var is_annotation = result.result.is_annotation;

                                angular.extend(self.chartOptions89.yAxis, {
                                    min: 0,
                                    max: 100
                                });

                                if (self.list_object.timewidget != undefined) {

                                    if (self.list_object.timewidget.display_value === true) {
                                ...
                                if (self.list_object.timewidget != undefined) {
                                    ...
                                    if (self.list_object.timewidget.legends_align == 'bottom') {
                                    ...
                                    else if (self.list_object.timewidget.legends_align == 'left') {
                        ...
                        self.head_coun = function (final_work, type) {
                            if (type == undefined) {
                                type = 'day'
                            }
                            ...
                            var hea_cou = '/api/head_count/' + self.data_to_show + type + final_work + '&chart_name=89';

                            return $http({ method: "GET", url: hea_cou }).success(function (result) {

                                var date_list = result.result.date;
                                var head_count_value = result.result.head_value;
                                var is_annotation = result.result.is_annotation;

                                if (self.list_object.head_count != undefined) {

                                    if (self.list_object.head_count.display_value === true) {
                                ...
                                if (self.list_object.head_count != undefined) {
                                    ...
                                    if (self.list_object.head_count.legends_align == 'bottom') {
                                    ...
                                    else if (self.list_object.head_count.legends_align == 'left') {
                                ...
                                angular.extend(self.chartOptions94, {
                                    xAxis: {
                                        categories: date_list,
                                    },
                                    legend: {
                                                ...
                                                events: {
                                                    contextmenu: function () {
                                                        if (self.role_for_perm == 'customer') {
                                                            ...
                                                            var str = '89<##>' + self.type + '<##>' + sub_proj + '<##>' + work_pack + '<##>' + sub_pack;
                                                            this['project'] = self.project_live;
                                                            this['center'] = self.center_live;
                                                            this['from'] = self.start_date;
                                                            this['to'] = self.end_date;
                                                            return new Annotation(str, $(self.chartOptions94.chart.renderTo), this.series.chart, this);
                                                        }
                                                    }
                                                }
                                            },
                                                ...
                                                show: function () {
                                                    ...
                                                    if (self.anno_obj) {
                                                        if (chart_name.indexOf(name) >= 0) {
                                                            ...
                                                            $(document).find('.widget-89a').children(".widget-89b").find('.annotation-marker[series-name="' + name + '"]').css("opacity", 1);
                                                        }
                                                    }                                                    
                                                }
                                            }
                                        ...
                                        if (is_annotation) {
                                            ...
                                            for (var i in chart_data) {
                                                ...
                                                (function (series) {
                                                    $http({
                                                        method: "GET", url: "/api/annotations/?series_name=" + series.name + '&type=' +
                                                            self.type + '&chart_name=89&project=' + self.project_live + '&center=' +
                                                            self.center_live + '&from=' + self.start_date + '&to=' + self.end_date
                                                    }).success(function (annotations) {
                                                        annotations = _.sortBy(annotations.result, function (annotation) { return annotation.epoch });
                                                        $.each(annotations, function (j, annotation) {
                                                            ...
                                                            if (annotation.epoch) {
                                                                var a = new Annotation("89", $(self.chartOptions94.chart.renderTo),
                                                                    chart, point, annotation);
                                                                window.anno_obj = a;
                                                                self.anno_obj.push(a);
                                                                self._prod_avg.push(series.name);
                                ...
                                $('.widget-89a').removeClass('widget-loader-show');
                                $('.widget-89b').removeClass('widget-data-hide');
                            })
                        }
                                                    ...
                                                    (function (series) {
                                                        $http({
                                                            method: "GET", url: "/api/annotations/?series_name=" + series.name + '&type=' +
                                                                ...
                                                                self.center_live + '&from=' + self.start_date + '&to=' + self.end_date + '&chart_type=bar'
                                                        }).success(function (annotations) {
                                                            annotations = _.sortBy(annotations.result, function (annotation) { return annotation.epoch });
                                                            $.each(annotations, function (j, annotation) {
                        ...
                        self.static_total_errors = function () {
                            var tot_err = '/api/total_error/' + self.data_to_show + packet + '&chart_name=109';
                            return $http({ method: "GET", url: tot_err }).success(function (result) {
                                $('#109-title').empty();
                                if (isEmpty(result.result.total_err)) {
                                    $('.widget-109b').empty();
                                    var table_html1 = '<div style="margin-top:100px;font-size:15px; color:#5b5b5b; font-weight:bold; display:flex; justify-content:center;" id="No_data"><span>No data to display</span></div>';
                                    $(".widget-109b highcharts").remove();
                                    $('.widget-109b').css('overflow', 'auto');
                                    var $el = $(table_html1).appendTo(".widget-body.widget-109b");
                                    $compile($el)($scope);
                                    $('.widget-109a').removeClass('widget-loader-show');
                                    $('.widget-109b').removeClass('widget-data-hide');
                                }
                                else {
                                    var err_data = result.result.total_err[0].data[0];
                                    $('.widget-109b').empty();
                                    var table_html = '<div style="margin-top:50px;font-size:25px; color:#5b5b5b; font-weight:bold; display:flex; justify-content:center;"><span>Total Errors <br><center><span style="font-size:60px;">' + err_data + '</span></center></span></div>';
                                    $(".widget-109b highcharts").remove();
                                    $('.widget-109b').css('overflow', 'auto');
                                    var $el = $(table_html).appendTo(".widget-body.widget-109b");
                                    $compile($el)($scope);
                                    $('.widget-109a').removeClass('widget-loader-show');
                                    $('.widget-109b').removeClass('widget-data-hide');
                                }
                        ...
                        self.static_total_production = function () {
                            
                            var hour_tot_prod = '/api/hourly_tot_prod/' + self.data_to_show + packet + '&chart_name=110';
                            return $http({ method: "GET", url: hour_tot_prod }).success(function (result) {
                                $('#110-title').empty();
                                if (isEmpty(result.result.total)) {
                                    $('.widget-110b').empty();
                                    var table_html1 = '<div style="margin-top:100px;font-size:15px; color:#5b5b5b; font-weight:bold; display:flex; justify-content:center;" id="No_data"><span>No data to display</span></div>';
                                    $(".widget-110b highcharts").remove();
                                    $('.widget-110b').css('overflow', 'auto');
                                    var $el = $(table_html1).appendTo(".widget-body.widget-110b");
                                    $compile($el)($scope);
                                    $('.widget-110a').removeClass('widget-loader-show');
                                    $('.widget-110b').removeClass('widget-data-hide');
                                }
                                else {
                                    var err_data = result.result.total[0].data[0];
                                    $('.widget-110b').empty();
                                    var table_html = '<div style="margin-top:50px;font-size:25px; color:#5b5b5b; font-weight:bold; display:flex; justify-content:center;"><span>Total Production <br><center><span style="font-size:60px;">' + err_data + '</span></center></span></div>';
                                    $(".widget-110b highcharts").remove();
                                    $('.widget-110b').css('overflow', 'auto');
                                    var $el = $(table_html).appendTo(".widget-body.widget-110b");
                                    $compile($el)($scope);
                                    $('.widget-110a').removeClass('widget-loader-show');
                                    $('.widget-110b').removeClass('widget-data-hide');
                                }
                        ...
                        self.static_total_logins = function () {

                            var tot_log = '/api/total_login/' + self.data_to_show  + '&chart_name=111';
                            return $http({ method: "GET", url: tot_log }).success(function (result) {
                                $('#111-title').empty();
                                if (isEmpty(result.result.total_login)) {
                                    $('.widget-111b').empty();
                                    var table_html1 = '<div style="margin-top:100px;font-size:15px; color:#5b5b5b; font-weight:bold; display:flex; justify-content:center;" id="No_data"><span>No data to display</span></div>';
                                    $(".widget-111b highcharts").remove();
                                    $('.widget-111b').css('overflow', 'auto');
                                    var $el = $(table_html1).appendTo(".widget-body.widget-111b");
                                    $compile($el)($scope);
                                    $('.widget-111a').removeClass('widget-loader-show');
                                    $('.widget-111b').removeClass('widget-data-hide');
                                }
                                else {
                                    var err_data = result.result.total_login[0].data[0];
                                    $('.widget-111b').empty();
                                    var table_html = '<div style="margin-top:50px;font-size:25px; color:#5b5b5b; font-weight:bold; display:flex; justify-content:center;"><span>Total Logins <br><center><span style="font-size:60px;">' + err_data + '</span></center></span></div>';
                                    $(".widget-111b highcharts").remove();
                                    $('.widget-111b').css('overflow', 'auto');
                                    var $el = $(table_html).appendTo(".widget-body.widget-111b");
                                    $compile($el)($scope);
                                    $('.widget-111a').removeClass('widget-loader-show');
                                    $('.widget-111b').removeClass('widget-data-hide');
                                }
                        ...
                        self.Error_Count_Category = function (final_work, type) {
                            ...
                            var err_cnt_cate = '/api/error_cate_count/' + self.data_to_show + type + final_work + '&chart_name=88';

                            return $http({ method: "GET", url: err_cnt_cate }).success(function (result) {

                                var date_list = result.result.date;
                                var err_cate = result.result.external_error_count;
                                var is_annotation = result.result.is_annotation;

                                if (self.list_object.external_error_count_widget != undefined) {

                                    if (self.list_object.external_error_count_widget.display_value === true) {
                                ...
                                if (self.list_object.external_error_count_widget != undefined) {
                                    ...
                                    if (self.list_object.external_error_count_widget.legends_align == 'bottom') {
                                    ...
                                    else if (self.list_object.external_error_count_widget.legends_align == 'left') {
                                ...
                                angular.extend(self.chartOptions93.yAxis, {
                                    min: result.result.min_max.min_value,
                                    max: result.result.min_max.max_value
                                });

                                angular.extend(self.chartOptions93, {
                                    xAxis: {
                                        categories: date_list,
                                    },
                                    legend: {
                                                ...
                                                events: {
                                                    contextmenu: function () {
                                                        if (self.role_for_perm == 'customer') {
                                                            ...
                                                            var str = '88<##>' + self.type + '<##>' + sub_proj + '<##>' + work_pack + '<##>' + sub_pack;
                                                            this['project'] = self.project_live;
                                                            this['center'] = self.center_live;
                                                            this['from'] = self.start_date;
                                                            this['to'] = self.end_date;
                                                            return new Annotation(str, $(self.chartOptions93.chart.renderTo), this.series.chart, this);
                                                        }
                                                    }
                                                }
                                            },
                                                ...
                                                hide: function () {
                                                    ...
                                                    if (self.data_anno) {
                                                        if (chart_name.indexOf(name) >= 0) {
                                                            ...
                                                            $(document).find('.widget-88a').children(".widget-88b").find('.annotation-marker[series-name="' + name + '"]').css("opacity", 0);
                                                        }
                                                    }
                                                },
                                                show: function () {
                                                    var name = this.name;
                                                    var visibility = this.visible;
                                                    var chart_name = self._internal_data;
                                                    if (self.data_anno) {
                                                        if (chart_name.indexOf(name) >= 0) {
                                                            self.data_anno.forEach(function (value_data) {
                                                                value_data.redraw(name, visibility);
                                                            });
                                                            $(document).find('.widget-88a').children(".widget-88b").find('.annotation-marker[series-name="' + name + '"]').css("opacity", 1);
                                                        }
                                                    }
                                                }
                                            }
                                        ...
                                        if (is_annotation) {
                                            ...
                                            for (var i in chart_data) {
                                                ...
                                                (function (series) {
                                                    $http({
                                                        method: "GET", url: "/api/annotations/?series_name=" + series.name + '&type=' +
                                                            self.type + '&chart_name=88&project=' + self.project_live + '&center=' +
                                                            self.center_live + '&from=' + self.start_date + '&to=' + self.end_date
                                                    }).success(function (annotations) {
                                                        annotations = _.sortBy(annotations.result, function (annotation) { return annotation.epoch });
                                                        $.each(annotations, function (j, annotation) {
                                                            ...
                                                            if (annotation.epoch) {
                                                                var a = new Annotation("88", $(self.chartOptions93.chart.renderTo),
                                                                    chart, point, annotation);
                                                                window.data_anno = a;
                                                                self.data_anno.push(a);
                                                                self._internal_data.push(series.name);
                                                                self.annot_perm();
                                                            }
                                                        })
                                ...
                                $('.widget-88a').removeClass('widget-loader-show');
                                $('.widget-88b').removeClass('widget-data-hide');
                            })
                        }



                        self.Production_vs_target = function (final_work, type) {
                            ...
                            var prod_targ = '/api/produc_vs_target/' + self.data_to_show + type + final_work + '&chart_name=90';

                            return $http({ method: "GET", url: prod_targ }).success(function (result) {

                                var date_list = result.result.date;
                                var prod_target = result.result.produc_vs_targ;
                                var is_annotation = result.result.is_annotation;

                                if (self.list_object.production_vs_target != undefined) {

                                    if (self.list_object.production_vs_target.display_value === true) {
                                ...
                                if (self.list_object.production_vs_target != undefined) {
                                    ...
                                    if (self.list_object.production_vs_target.legends_align == 'bottom') {
                                    ...
                                    else if (self.list_object.production_vs_target.legends_align == 'left') {
                                ...
                                angular.extend(self.chartOptions95.yAxis, {
                                    min: result.result.min_max.min_value,
                                    max: result.result.min_max.max_value
                                });

                                angular.extend(self.chartOptions95, {
                                    xAxis: {
                                        categories: date_list,
                                    },
                                    legend: {
                                        ...
                                        series: {
                                                ...
                                                events: {
                                                    contextmenu: function () {
                                                        if (self.role_for_perm == 'customer') {
                                                            ...
                                                            var str = '90<##>' + self.type + '<##>' + sub_proj + '<##>' + work_pack + '<##>' + sub_pack;
                                                            this['project'] = self.project_live;
                                                            this['center'] = self.center_live;
                                                            this['from'] = self.start_date;
                                                            this['to'] = self.end_date;
                                                            return new Annotation(str, $(self.chartOptions95.chart.renderTo), this.series.chart, this);
                                                        }
                                                    }
                                                }
                                            },
                                            events: {
                                                hide: function () {
                                                    var name = this.name;
                                                    var visibility = this.visible;
                                                    var chart_name = self._prod_targ;
                                                    if (self.data_anno) {
                                                        if (chart_name.indexOf(name) >= 0) {
                                                            self.data_anno.forEach(function (value_data) {
                                                                value_data.redraw(name, visibility);
                                                            });
                                                            $(document).find('.widget-90a').children(".widget-90b").find('.annotation-marker[series-name="' + name + '"]').css("opacity", 0);
                                                        }
                                                    }
                                                },
                                                show: function () {
                                                    ...
                                                    if (self.data_anno) {
                                                        if (chart_name.indexOf(name) >= 0) {
                                                            ...
                                                            $(document).find('.widget-90a').children(".widget-90b").find('.annotation-marker[series-name="' + name + '"]').css("opacity", 1);
                                                        }
                                                    }
                                                }
                                            }
                                        ...
                                        if (is_annotation) {
                                            ...
                                            for (var i in chart_data) {
                                                ...
                                                (function (series) {
                                                    $http({
                                                        method: "GET", url: "/api/annotations/?series_name=" + series.name + '&type=' +
                                                            self.type + '&chart_name=90&project=' + self.project_live + '&center=' +
                                                            self.center_live + '&from=' + self.start_date + '&to=' + self.end_date
                                                    }).success(function (annotations) {
                                                        annotations = _.sortBy(annotations.result, function (annotation) { return annotation.epoch });
                                                        $.each(annotations, function (j, annotation) {
                                                            ...
                                                            if (annotation.epoch) {
                                                                var a = new Annotation("90", $(self.chartOptions95.chart.renderTo),
                                                                    chart, point, annotation);
                                                                window.data_anno = a;
                                                                self.data_anno.push(a);
                                                                self._prod_targ.push(series.name);
                                                                self.annot_perm();
                                                            }
                                                        })
                                ...
                                $('.widget-90a').removeClass('widget-loader-show');
                                $('.widget-90b').removeClass('widget-data-hide');
                            })
                        }



                        self.Overall_Headcount = function (final_work, type) {
                            if (type == undefined) {
                                type = 'day'
                            }
                            ...
                            var overall_head_count = '/api/overall_head_count/' + self.data_to_show + type + final_work + '&chart_name=91';

                            return $http({ method: "GET", url: overall_head_count }).success(function (result) {

                                var date_list = result.result.date;
                                var overall_head_var = result.result.overall_head_count;
                                var is_annotation = result.result.is_annotation;

                                if (self.list_object.overall_head_count != undefined) {

                                    if (self.list_object.overall_head_count.display_value === true) {
                                ...
                                if (self.list_object.overall_head_count != undefined) {
                                    ...
                                    if (self.list_object.overall_head_count.legends_align == 'bottom') {
                                    ...
                                    else if (self.list_object.overall_head_count.legends_align == 'left') {
                                ...
                                angular.extend(self.chartOptions96, {
                                    xAxis: {
                                        categories: date_list,
                                    },
                                    legend: {
                                        ...
                                        series: {
                                                ...
                                                events: {
                                                    contextmenu: function () {
                                                        if (self.role_for_perm == 'customer') {
                                                            ...
                                                            var str = '91<##>' + self.type + '<##>' + sub_proj + '<##>' + work_pack + '<##>' + sub_pack;
                                                            this['project'] = self.project_live;
                                                            this['center'] = self.center_live;
                                                            this['from'] = self.start_date;
                                                            this['to'] = self.end_date;
                                                            return new Annotation(str, $(self.chartOptions96.chart.renderTo), this.series.chart, this);
                                                        }
                                                    }
                                                }
                                            },
                                            events: {
                                                hide: function () {
                                                    var name = this.name;
                                                    var visibility = this.visible;
                                                    var chart_name = self._over_head;
                                                    if (self.anno_obj) {
                                                        if (chart_name.indexOf(name) >= 0) {
                                                            self.anno_obj.forEach(function (value_data) {
                                                                value_data.redraw(name, visibility);
                                                            });
                                                            $(document).find('.widget-91a').children(".widget-91b").find('.annotation-marker[series-name="' + name + '"]').css("opacity", 0);
                                                        }
                                                    }                                                    
                                                },
                                                show: function () {
                                                    ...
                                                    if (self.anno_obj) {
                                                        if (chart_name.indexOf(name) >= 0) {
                                                            ...
                                                            $(document).find('.widget-91a').children(".widget-91b").find('.annotation-marker[series-name="' + name + '"]').css("opacity", 1);
                                                        }
                                                    }                                                    
                                                }
                                            }
                                        ...
                                        if (is_annotation) {
                                            ...
                                            for (var i in chart_data) {
                                                ...
                                                (function (series) {
                                                    $http({
                                                        method: "GET", url: "/api/annotations/?series_name=" + series.name + '&type=' +
                                                            self.type + '&chart_name=91&project=' + self.project_live + '&center=' +
                                                            self.center_live + '&from=' + self.start_date + '&to=' + self.end_date
                                                    }).success(function (annotations) {
                                                        annotations = _.sortBy(annotations.result, function (annotation) { return annotation.epoch });
                                                        $.each(annotations, function (j, annotation) {
                                                            ...
                                                            if (annotation.epoch) {
                                                                var a = new Annotation("91", $(self.chartOptions96.chart.renderTo),
                                                                    chart, point, annotation);
                                                                window.anno_obj = a;
                                                                self.anno_obj.push(a);
                                                                self._over_head.push(series.name);
                                                                self.annot_perm();
                                                            }
                                                        })
                                ...
                                $('.widget-91a').removeClass('widget-loader-show');
                                $('.widget-91b').removeClass('widget-data-hide');
                            })
                        }


                        self.Overall_Production = function (final_work, type) {
                        ...
                        self.Ext_Err_Count = function (final_work, type) {
                            ...
                            var ext_err_cnt = '/api/ext_error_count/' + self.data_to_show + type + final_work + '&chart_name=94';

                            return $http({ method: "GET", url: ext_err_cnt }).success(function (result) {

                                var date_list = result.result.date;
                                var err_cate = result.result.overall_external_count;
                                var is_annotation = result.result.is_annotation;

                                if (self.list_object.overall_external_error != undefined) {

                                    if (self.list_object.overall_external_error.display_value === true) {
                                ...
                                if (self.list_object.overall_external_error != undefined) {
                                    ...
                                    if (self.list_object.overall_external_error.legends_align == 'bottom') {
                                    ...
                                    else if (self.list_object.overall_external_error.legends_align == 'left') {
                                ...
                                angular.extend(self.chartOptions99.yAxis, {
                                    min: result.result.min_max.min_value,
                                    max: result.result.min_max.max_value
                                });

                                angular.extend(self.chartOptions99, {
                                    xAxis: {
                                        categories: date_list,
                                    },
                                    legend: {
                                        ...
                                        series: {
                                                ...
                                                events: {
                                                    contextmenu: function () {
                                                        if (self.role_for_perm == 'customer') {
                                                            ...
                                                            var str = '94<##>' + self.type + '<##>' + sub_proj + '<##>' + work_pack + '<##>' + sub_pack;
                                                            this['project'] = self.project_live;
                                                            this['center'] = self.center_live;
                                                            this['from'] = self.start_date;
                                                            this['to'] = self.end_date;
                                            ...
                                            events: {
                                                hide: function () {
                                                    var name = this.name;
                                                    var visibility = this.visible;
                                                    var chart_name = self._external_data;
                                                    if (self.data_anno) {
                                                        if (chart_name.indexOf(name) >= 0) {
                                                            self.data_anno.forEach(function (value_data) {
                                                                value_data.redraw(name, visibility);
                                                            });
                                                            $(document).find('.widget-94a').children(".widget-94b").find('.annotation-marker[series-name="' + name + '"]').css("opacity", 0);
                                                        }
                                                    }
                                                },
                                                show: function () {
                                                    ...
                                                    if (self.data_anno) {
                                                        if (chart_name.indexOf(name) >= 0) {
                                                            ...
                                                            $(document).find('.widget-94a').children(".widget-94b").find('.annotation-marker[series-name="' + name + '"]').css("opacity", 1);
                                                        }
                                                    }
                                                }
                                            }
                                        ...
                                        if (is_annotation) {
                                            ...
                                            for (var i in chart_data) {
                                                ...
                                                (function (series) {
                                                    $http({
                                                        method: "GET", url: "/api/annotations/?series_name=" + series.name + '&type=' +
                                                            self.type + '&chart_name=94&project=' + self.project_live + '&center=' +
                                                            self.center_live + '&from=' + self.start_date + '&to=' + self.end_date
                                                    }).success(function (annotations) {
                                                        annotations = _.sortBy(annotations.result, function (annotation) { return annotation.epoch });
                                                        $.each(annotations, function (j, annotation) {
                                                            ...
                                                            if (annotation.epoch) {
                                                                var a = new Annotation("94", $(self.chartOptions99.chart.renderTo),
                                                                    chart, point, annotation);
                                                                window.data_anno = a;
                                                                self.data_anno.push(a);
                                                                self._external_data.push(series.name);
                                                                self.annot_perm();
                                                            }
                                                        })
                                ...
                                $('.widget-94a').removeClass('widget-loader-show');
                                $('.widget-94b').removeClass('widget-data-hide');
                            })
                        }

                        self.Int_Acc_Trend = function (final_work, type) {
                            ...
                            var int_acc_trd = '/api/int_acc_trend/' + self.data_to_show + type + final_work + '&chart_name=95';
                        
                            return $http({ method: "GET", url: int_acc_trd }).success(function (result) {
                        
                                var date_list = result.result.date;
                                var err_cate = result.result.internal_error_acc;
                                var is_annotation = result.result.is_annotation;
                        
                                if (self.list_object.overall_internal_accuracy != undefined) {
                        
                                    if (self.list_object.overall_internal_accuracy.display_value === true) {
                                ...
                                if (self.list_object.overall_internal_accuracy != undefined) {
                                    ...
                                    if (self.list_object.overall_internal_accuracy.legends_align == 'bottom') {
                                    ...
                                    else if (self.list_object.overall_internal_accuracy.legends_align == 'left') {
                                ...
                                angular.extend(self.chartOptions100.yAxis, {
                                    min: result.result.min_max.min_value,
                                    max: result.result.min_max.max_value
                                });
                        
                                angular.extend(self.chartOptions100, {
                                    xAxis: {
                                        categories: date_list,
                                    },
                                    legend: {
                                                ...
                                                events: {
                                                    contextmenu: function () {
                                                        if (self.role_for_perm == 'customer') {
                                                            ...
                                                            var str = '95<##>' + self.type + '<##>' + sub_proj + '<##>' + work_pack + '<##>' + sub_pack;
                                                            this['project'] = self.project_live;
                                                            this['center'] = self.center_live;
                                                            this['from'] = self.start_date;
                                                            this['to'] = self.end_date;
                                                            return new Annotation(str, $(self.chartOptions100.chart.renderTo), this.series.chart, this);
                                                        }
                                                    }
                                                }
                                            },
                                                ...
                                                hide: function () {
                                                    ...
                                                    if (self.data_anno) {
                                                        if (chart_name.indexOf(name) >= 0) {
                                                            ...
                                                            $(document).find('.widget-95a').children(".widget-95b").find('.annotation-marker[series-name="' + name + '"]').css("opacity", 0);
                                                        }
                                                    }
                                                },
                                                show: function () {
                                                    ...
                                                    if (self.data_anno) {
                                                        if (chart_name.indexOf(name) >= 0) {
                                                            ...
                                                            $(document).find('.widget-95a').children(".widget-95b").find('.annotation-marker[series-name="' + name + '"]').css("opacity", 1);
                                                        }
                                                    }
                                                }
                                            }
                                        ...
                                        if (is_annotation) {
                                            ...
                                            for (var i in chart_data) {
                                                ...
                                                (function (series) {
                                                    $http({
                                                        method: "GET", url: "/api/annotations/?series_name=" + series.name + '&type=' +
                                                            self.type + '&chart_name=96&project=' + self.project_live + '&center=' +
                                                            self.center_live + '&from=' + self.start_date + '&to=' + self.end_date
                                                    }).success(function (annotations) {
                                                        annotations = _.sortBy(annotations.result, function (annotation) { return annotation.epoch });
                                                        $.each(annotations, function (j, annotation) {
                                                            ...
                                                            if (annotation.epoch) {
                                                                var a = new Annotation("95", $(self.chartOptions100.chart.renderTo),
                                                                    chart, point, annotation);
                                                                window.data_anno = a;
                                                                self.data_anno.push(a);
                                                                self._internal_data.push(series.name);
                                ...
                                $('.widget-95a').removeClass('widget-loader-show');
                                $('.widget-95b').removeClass('widget-data-hide');
                            })
                        }
                        

                        self.Tat_Date_Wise = function (final_work, type) {
                            ...
                            var tat_date_url = '/api/tat_graph_date/' + self.data_to_show + type + final_work + '&chart_name=96';
                        
                            return $http({ method: "GET", url: tat_date_url }).success(function (result) {
                        
                                var date_list = result.result.date;
                                var result_tat = result.result.overall_tat;
                                var is_annotation = result.result.is_annotation;
                                
                                if (self.list_object.tat_date != undefined) {
                        
                                    if (self.list_object.tat_date.display_value === true) {
                                ...
                                if (self.list_object.tat_date != undefined) {
                                    ...
                                    if (self.list_object.tat_date.legends_align == 'bottom') {
                                    ...
                                    else if (self.list_object.tat_date.legends_align == 'left') {
                                ...
                                angular.extend(self.chartOptions101.yAxis, {
                                    min: result.result.min_max.min_value,
                                    max: result.result.min_max.max_value
                                });
                        
                                angular.extend(self.chartOptions101, {
                                    xAxis: {
                                        categories: date_list,
                                    },
                                    legend: {
                                        ...
                                        series: {
                                                ...
                                                events: {
                                                    contextmenu: function () {
                                                        if (self.role_for_perm == 'customer') {
                                                            ...
                                                            var str = '96<##>' + self.type + '<##>' + sub_proj + '<##>' + work_pack + '<##>' + sub_pack;
                                                            this['project'] = self.project_live;
                                                            this['center'] = self.center_live;
                                                            this['from'] = self.start_date;
                                                            this['to'] = self.end_date;
                                                            return new Annotation(str, $(self.chartOptions101.chart.renderTo), this.series.chart, this);
                                                        }
                                                    }
                                                }
                                            },
                                            events: {
                                                hide: function () {
                                                    var name = this.name;
                                                    var visibility = this.visible;
                                                    var chart_name = self._tat_lst;
                                                    if (self.data_anno) {
                                                        if (chart_name.indexOf(name) >= 0) {
                                                            self.data_anno.forEach(function (value_data) {
                                                                value_data.redraw(name, visibility);
                                                            });
                                                            $(document).find('.widget-96a').children(".widget-96b").find('.annotation-marker[series-name="' + name + '"]').css("opacity", 0);
                                                        }
                                                    }
                                                },
                                                show: function () {
                                                    ...
                                                    if (self.data_anno) {
                                                        if (chart_name.indexOf(name) >= 0) {
                                                            ...
                                                            $(document).find('.widget-96a').children(".widget-96b").find('.annotation-marker[series-name="' + name + '"]').css("opacity", 1);
                                                        }
                                                    }
                                                }
                                            }
                                                ...
                                                (function (series) {
                                                    $http({
                                                        ...
                                                        $.each(annotations, function (j, annotation) {
                                                            ...
                                                            if (annotation.epoch) {
                                                                var a = new Annotation("96", $(self.chartOptions101.chart.renderTo),
                                                                    chart, point, annotation);
                                                                window.data_anno = a;
                                                                self.data_anno.push(a);
                                                                self._tat_lst.push(series.name);
                                                                self.annot_perm();
                                                            }
                                                        })
                                ...
                                $('.widget-96a').removeClass('widget-loader-show');
                                $('.widget-96b').removeClass('widget-data-hide');
                            })
                        }
                        ...
                        self.Probe_overall_ext_accracy = function (final_work, type) {
                            ...
                            var prb_ext_url = '/api/prob_ovr_ext_acc/' + self.data_to_show + type + final_work + '&chart_name=100';
                        
                            return $http({ method: "GET", url: prb_ext_url }).success(function (result) {
                        
                                var date_list = result.result.date;
                                var result_pr_over = result.result.prb_overall_ext;
                                var is_annotation = result.result.is_annotation;
                                
                                if (self.list_object.probe_overall_external_accuracy != undefined) {
                        
                                    if (self.list_object.probe_overall_external_accuracy.display_value === true) {
                                ...
                                if (self.list_object.probe_overall_external_accuracy != undefined) {
                                    ...
                                    if (self.list_object.probe_overall_external_accuracy.legends_align == 'bottom') {
                                    ...
                                    else if (self.list_object.probe_overall_external_accuracy.legends_align == 'left') {
                                ...
                                angular.extend(self.chartOptions105.yAxis, {
                                    min: result.result.min_max.min_value,
                                    max: result.result.min_max.max_value
                                });
                        
                                angular.extend(self.chartOptions105, {
                                    xAxis: {
                                        categories: date_list,
                                    },
                                    legend: {
                                        ...
                                        series: {
                                                ...
                                                events: {
                                                    contextmenu: function () {
                                                        if (self.role_for_perm == 'customer') {
                                                            ...
                                                            var str = '100<##>' + self.type + '<##>' + sub_proj + '<##>' + work_pack + '<##>' + sub_pack;
                                                            this['project'] = self.project_live;
                                                            this['center'] = self.center_live;
                                                            this['from'] = self.start_date;
                                                            this['to'] = self.end_date;
                                                            return new Annotation(str, $(self.chartOptions105.chart.renderTo), this.series.chart, this);
                                                        }
                                                    }
                                                }
                                            },
                                            events: {
                                                hide: function () {
                                                    var name = this.name;
                                                    var visibility = this.visible;
                                                    var chart_name = self._pr_ext_acc;
                                                    if (self.data_anno) {
                                                        if (chart_name.indexOf(name) >= 0) {
                                                            self.data_anno.forEach(function (value_data) {
                                                                value_data.redraw(name, visibility);
                                                            });
                                                            $(document).find('.widget-100a').children(".widget-100b").find('.annotation-marker[series-name="' + name + '"]').css("opacity", 0);
                                                        }
                                                    }
                                                },
                                                show: function () {
                                                    ...
                                                    if (self.data_anno) {
                                                        if (chart_name.indexOf(name) >= 0) {
                                                            ...
                                                            $(document).find('.widget-100a').children(".widget-100b").find('.annotation-marker[series-name="' + name + '"]').css("opacity", 1);
                                                        }
                                                    }
                                                }
                                            }
                                        ...
                                        if (is_annotation) {
                                            ...
                                            for (var i in chart_data) {
                                                ...
                                                (function (series) {
                                                    $http({
                                                        method: "GET", url: "/api/annotations/?series_name=" + series.name + '&type=' +
                                                            self.type + '&chart_name=100&project=' + self.project_live + '&center=' +
                                                            self.center_live + '&from=' + self.start_date + '&to=' + self.end_date
                                                    }).success(function (annotations) {
                                                        annotations = _.sortBy(annotations.result, function (annotation) { return annotation.epoch });
                                                        $.each(annotations, function (j, annotation) {
                                                            ...
                                                            if (annotation.epoch) {
                                                                var a = new Annotation("100", $(self.chartOptions105.chart.renderTo),
                                                                    chart, point, annotation);
                                                                window.data_anno = a;
                                                                self.data_anno.push(a);
                                                                self._pr_ext_acc.push(series.name);
                                                                self.annot_perm();
                                                            }
                                                        })
                                ...
                                $('.widget-100a').removeClass('widget-loader-show');
                                $('.widget-100b').removeClass('widget-data-hide');
                            })
                        }

                        
                        self.Agent_Wise_Internal_Accuracy = function (final_work, type) {
                            ...
                            var int_acc_agent = '/api/int_acc_agent/' + self.data_to_show + type + final_work + '&chart_name=97';
                        
                            return $http({ method: "GET", url: int_acc_agent }).success(function (result) {
                        
                                var date_list = result.result.date;
                                var int_acc_agent_data = result.result.int_acc_agent_details;
                                var is_annotation = result.result.is_annotation;
                        
                                if (self.list_object.internal_accuracy_agents_wise != undefined) {
                        
                                    if (self.list_object.internal_accuracy_agents_wise.display_value === true) {
                                                    ...
                                                    contextmenu: function () {
                                                        if (self.role_for_perm == 'customer') {
                                                            ...
                                                            if (self.data_to_show.split('&').length == 6) {
                                                                ...
                                                                var sub_proj = self.data_to_show.split('&')[6].split('=')[1];
                                                                var work_pack = self.data_to_show.split('&')[7].split('=')[1];
                                                                var sub_pack = self.data_to_show.split('&')[8].split('=')[1]
                                                            }
                                                            
                                                            var str = '97<##>' + self.type + '<##>' + sub_proj + '<##>' + work_pack + '<##>' + sub_pack;
                                                            this['project'] = self.project_live;
                                                            this['center'] = self.center_live;
                                                            this['from'] = self.start_date;
                                                            this['to'] = self.end_date;
                                                            this['chart_type'] = 'bar';
                                                            return new Annotation(str, $(self.chartOptions102.chart.renderTo), this.series.chart, this);
                                                        }
                                                    }
                                                }
                                            },
                                            events: {
                                                hide: function () {
                                                    if (self.annotObj) {
                                                        if (self.annotObj.length > 0) {
                                                            window.annotObj.redraw(this.name, this.visible);
                                                            $(document).find('.widget-97a').find('.annotation-marker[series-name="' + this.name + '"]').hide();
                                                        }
                                                    }
                                                },
                                                show: function () {
                                                    if (self.annotObj) {
                                                        if (self.annotObj.length > 0) {
                                                            window.annotObj.redraw(this.name, this.visible);
                                                            $(document).find('.widget-97a').find('.annotation-marker[series-name="' + this.name + '"]').show();
                                                        }
                                                    }
                                                }
                                            }
                                        ...
                                        if (is_annotation) {
                                            ...
                                            for (var i in chart_data) {
                                                ...
                                                (function (series) {
                                                    $http({
                                                        method: "GET", url: "/api/annotations/?series_name=" + series.name + '&type=' +
                                                            self.type + '&chart_name=97&project=' + self.project_live + '&center=' +
                                                            self.center_live + '&from=' + self.start_date + '&to=' + self.end_date + '&chart_type=bar'
                                                    }).success(function (annotations) {
                                                        annotations = _.sortBy(annotations.result, function (annotation) { return annotation.epoch });
                                                        $.each(annotations, function (j, annotation) {
                                                            ...
                                                            if (annotation.epoch) {
                                                                var a = new Annotation("97", $(self.chartOptions102.chart.renderTo),
                                                                    chart, point, annotation);
                                                                window.annotObj = a;
                                                                self.annot_perm();
                                                            }
                                ...
                                $('.widget-97a').removeClass('widget-loader-show');
                                $('.widget-97b').removeClass('widget-data-hide');
                            })
                        }
                        
                        
                        self.Agent_Wise_External_Accuracy = function (final_work, type) {
                            ...
                            var ext_acc_agent = '/api/ext_acc_agent/' + self.data_to_show + type + final_work + '&chart_name=98';
                        
                            return $http({ method: "GET", url: ext_acc_agent }).success(function (result) {
                        
                                var date_list = result.result.date;
                                var ext_acc_agent_data = result.result.ext_acc_agent_details;
                                var is_annotation = result.result.is_annotation;
                        
                                if (self.list_object.external_accuracy_agents_wise != undefined) {
                        
                                    if (self.list_object.external_accuracy_agents_wise.display_value === true) {
                                                ...
                                                events: {
                                                    contextmenu: function () {
                                                        if (self.role_for_perm == 'customer') {
                                                            ...
                                                            var str = '98<##>' + self.type + '<##>' + sub_proj + '<##>' + work_pack + '<##>' + sub_pack;
                                                            this['project'] = self.project_live;
                                                            this['center'] = self.center_live;
                                                            this['from'] = self.start_date;
                                                            this['to'] = self.end_date;
                                                            this['chart_type'] = 'bar';
                                                            return new Annotation(str, $(self.chartOptions103.chart.renderTo), this.series.chart, this);
                                                        }
                                                    }
                                                }
                                            },
                                            events: {
                                                hide: function () {
                                                    if (self.annotObj) {
                                                        if (self.annotObj.length > 0) {
                                                            window.annotObj.redraw(this.name, this.visible);
                                                            $(document).find('.widget-98a').find('.annotation-marker[series-name="' + this.name + '"]').hide();
                                                        }
                                                    }
                                                },
                                                show: function () {
                                                    if (self.annotObj) {
                                                        if (self.annotObj.length > 0) {
                                                            window.annotObj.redraw(this.name, this.visible);
                                                            $(document).find('.widget-98a').find('.annotation-marker[series-name="' + this.name + '"]').show();
                                                        }
                                                    }
                                                }
                                            }
                                        ...
                                        if (is_annotation) {
                                            ...
                                            for (var i in chart_data) {
                                                ...
                                                (function (series) {
                                                    $http({
                                                        method: "GET", url: "/api/annotations/?series_name=" + series.name + '&type=' +
                                                            self.type + '&chart_name=98&project=' + self.project_live + '&center=' +
                                                            self.center_live + '&from=' + self.start_date + '&to=' + self.end_date + '&chart_type=bar'
                                                    }).success(function (annotations) {
                                                        annotations = _.sortBy(annotations.result, function (annotation) { return annotation.epoch });
                                                        $.each(annotations, function (j, annotation) {
                                                            ...
                                                            if (annotation.epoch) {
                                                                var a = new Annotation("98", $(self.chartOptions103.chart.renderTo),
                                                                    chart, point, annotation);
                                                                window.annotObj = a;
                                                                self.annot_perm();
                                                            }
                                ...
                                $('.widget-98a').removeClass('widget-loader-show');
                                $('.widget-98b').removeClass('widget-data-hide');
                            })
                        }
                        
                        
                        
                    self.Agent_Wise_Production = function (final_work, type) {
                        ...
                        var agent_wise_prod = '/api/agent_wise_production/' + self.data_to_show + type + final_work + '&chart_name=99';
                        
                        return $http({ method: "GET", url: agent_wise_prod }).success(function (result) {
                        
                        var date_list = result.result.date;
                        var agent_prod_var = result.result.agent_wise_production;
                        var is_annotation = result.result.is_annotation;
                        
                        if (self.list_object.agent_wise_production != undefined) {                            
                            if (self.list_object.agent_wise_production.display_value === true) {
                                        ...
                                        events: {
                                            contextmenu: function () {
                                                if (self.role_for_perm == 'customer') {
                                                    ...
                                                    var str = '99<##>' + self.type + '<##>' + sub_proj + '<##>' + work_pack + '<##>' + sub_pack;
                                                    this['project'] = self.project_live;
                                                    this['center'] = self.center_live;
                                                    this['from'] = self.start_date;
                                                    this['to'] = self.end_date;
                                                    this['chart_type'] = 'bar';
                                                    return new Annotation(str, $(self.chartOptions104.chart.renderTo), this.series.chart, this);
                                                }
                                            }
                                        }
                                    },
                                    events: {
                                        hide: function () {
                                            if (self.annotObj) {
                                                if (self.annotObj.length > 0) {
                                                    window.annotObj.redraw(this.name, this.visible);
                                                    $(document).find('.widget-99a').find('.annotation-marker[series-name="' + this.name + '"]').hide();
                                                }
                                            }
                                        },
                                        show: function () {
                                            if (self.annotObj) {
                                                if (self.annotObj.length > 0) {
                                                    window.annotObj.redraw(this.name, this.visible);
                                                    $(document).find('.widget-99a').find('.annotation-marker[series-name="' + this.name + '"]').show();
                                                }
                                            }
                                        }
                                    }
                                ...
                                if (is_annotation) {
                                    ...
                                    for (var i in chart_data) {
                                        ...
                                        (function (series) {
                                            $http({
                                                method: "GET", url: "/api/annotations/?series_name=" + series.name + '&type=' +
                                                    self.type + '&chart_name=99&project=' + self.project_live + '&center=' +
                                                    self.center_live + '&from=' + self.start_date + '&to=' + self.end_date + '&chart_type=bar'
                                            }).success(function (annotations) {
                                                annotations = _.sortBy(annotations.result, function (annotation) { return annotation.epoch });
                                                $.each(annotations, function (j, annotation) {
                                                    ...
                                                    if (annotation.epoch) {
                                                        var a = new Annotation("99", $(self.chartOptions104.chart.renderTo),
                                                            chart, point, annotation);
                                                        window.annotObj = a;
                                                        self.annot_perm();
                                                    }
                        ...
                        $('.widget-99a').removeClass('widget-loader-show');
                        $('.widget-99b').removeClass('widget-data-hide');
                        })
                                            ...
                                            onComplete: function (chart) {
                                                if (is_annotation) {
                                                    ...
                                                    for (var i in chart_data) {
                                                        ...
                                                        (function (series) {
                                                            $http({
                                                                method: "GET", url: "/api/annotations/?series_name=" + series.name + '&type=' + self.type + '&chart_name=7&project=' + self.project_live + '&center=' +
                                                                    self.center_live + '&from=' + self.start_date + '&to=' + self.end_date
                                                            }).success(function (annotations) {
                                                                annotations = _.sortBy(annotations.result, function (annotation) { return annotation.epoch });
                                                                $.each(annotations, function (j, annotation) {
                                            ...
                                            onComplete: function (chart) {
                                                if (is_annotation) {
                                                    ...
                                                    for (var i in chart_data) {
                                                        ...
                                                        (function (series) {
                                                            $http({
                                                                method: "GET", url: "/api/annotations/?series_name=" + series.name + '&type=' + self.type + '&chart_name=8&project=' + self.project_live + '&center=' +
                                                                    self.center_live + '&from=' + self.start_date + '&to=' + self.end_date
                                                            }).success(function (annotations) {
                                                                annotations = _.sortBy(annotations.result, function (annotation) { return annotation.epoch });
                                                                $.each(annotations, function (j, annotation) {
                        ...
                        self.Test_Widget_Hourly = function (final_work, type) {
                            ...
                            var hour_wise_prod = '/api/hourly_prod/' + self.data_to_show + type + final_work + '&chart_name=101';

                            return $http({ method: "GET", url: hour_wise_prod }).success(function (result) {

                                var date_list = result.result.date;
                                var overall_details = result.result.hourly_prod;
                                var is_annotation = "false";

                                if (self.list_object.test_widget_for_hourly != undefined) {

                                    if (self.list_object.test_widget_for_hourly.display_value === true) {
                                ...
                                if (self.list_object.test_widget_for_hourly != undefined) {
                                    ...
                                    if (self.list_object.test_widget_for_hourly.legends_align == 'bottom') {
                                    ...
                                    else if (self.list_object.test_widget_for_hourly.legends_align == 'left') {
                                ...
                                angular.extend(self.chartOptions106, {
                                                ...
                                                events: {
                                                    contextmenu: function () {
                                                        if (self.role_for_perm == 'customer') {
                                                            ...
                                                            var str = '101<##>' + self.type + '<##>' + sub_proj + '<##>' + work_pack + '<##>' + sub_pack;
                                                            this['project'] = self.project_live;
                                                            this['center'] = self.center_live;
                                                            this['from'] = self.start_date;
                                                            this['to'] = self.end_date;
                                                            return new Annotation(str, $(self.chartOptions106.chart.renderTo), this.series.chart, this);
                                                        }
                                                    }
                                                }
                                            },
                                                ...
                                                hide: function () {
                                                    ...
                                                    if (self.Obj_val) {
                                                        if (chart_name.indexOf(name) >= 0) {
                                                            ...
                                                            $(document).find('.widget-101a').children(".widget-101b").find('.annotation-marker[series-name="' + name + '"]').css("opacity", 0);
                                                        }
                                                    }
                                                },
                                                show: function () {
                                                    ...
                                                    if (self.Obj_val) {
                                                        if (chart_name.indexOf(name) >= 0) {
                                                            ...
                                                            $(document).find('.widget-101a').children(".widget-101b").find('.annotation-marker[series-name="' + name + '"]').css("opacity", 1);
                                                        }
                                                    }
                                                }
                                            }
                                        ...
                                        if (is_annotation) {
                                            ...
                                            for (var i in chart_data) {
                                                ...
                                                (function (series) {
                                                    $http({
                                                        method: "GET", url: "/api/annotations/?series_name=" + series.name + '&type=' +
                                                            self.type + '&chart_name=101&project=' + self.project_live + '&center=' +
                                                            self.center_live + '&from=' + self.start_date + '&to=' + self.end_date
                                                    }).success(function (annotations) {
                                                        annotations = _.sortBy(annotations.result, function (annotation) { return annotation.epoch });
                                                        $.each(annotations, function (j, annotation) {
                                                            ...
                                                            if (annotation.epoch) {
                                                                var a = new Annotation("101", $(self.chartOptions106.chart.renderTo),
                                                                    chart, point, annotation);
                                                                window.Obj_val = a;
                                                                self.Obj_val.push(a);
                                                                self._overall.push(series.name);
                                ...
                                $('.widget-101a').removeClass('widget-loader-show');
                                $('.widget-101b').removeClass('widget-data-hide');
                            })
                        };

                        self.Test_Hourly_Login = function (final_work, type) {
                            if (type == undefined) {
                                type = 'day'
                            }
                            ...
                            self.type = type;
                            var hour_wise_login = '/api/hourly_login/' + self.data_to_show + type + final_work + '&chart_name=102';
                            return $http({ method: "GET", url: hour_wise_login }).success(function (result) {

                                var date_list = result.result.date;
                                var agent_prod_var = result.result.hourly_login;
                                var is_annotation = "false";
                                
                                if (self.list_object.hourly_logins != undefined) {
                                    if (self.list_object.hourly_logins.display_value === true) {
                                ...
                                if (self.list_object.hourly_logins != undefined) {
                                    ...
                                    if (self.list_object.hourly_logins.legends_align == 'bottom') {
                                    ...
                                    else if (self.list_object.hourly_logins.legends_align == 'left') {
                                ...
                                angular.extend(self.chartOptions107, {
                                    xAxis: {
                                        categories: date_list,
                                    },
                                    legend: {
                                                ...
                                                events: {
                                                    contextmenu: function () {
                                                        if (self.role_for_perm == 'customer') {
                                                            ...
                                                            var str = '102<##>' + self.type + '<##>' + sub_proj + '<##>' + work_pack + '<##>' + sub_pack;
                                                            this['project'] = self.project_live;
                                                            this['center'] = self.center_live;
                                                            this['from'] = self.start_date;
                                                            this['to'] = self.end_date;
                                                            this['chart_type'] = 'bar';
                                                            return new Annotation(str, $(self.chartOptions107.chart.renderTo), this.series.chart, this);
                                                        }
                                                    }
                                                }
                                            },
                                            events: {
                                                hide: function () {
                                                    if (self.annotObj) {
                                                        if (self.annotObj.length > 0) {
                                                            window.annotObj.redraw(this.name, this.visible);
                                                            $(document).find('.widget-102a').find('.annotation-marker[series-name="' + this.name + '"]').hide();
                                                        }
                                                    }
                                                },
                                                show: function () {
                                                    if (self.annotObj) {
                                                        if (self.annotObj.length > 0) {
                                                            window.annotObj.redraw(this.name, this.visible);
                                                            $(document).find('.widget-102a').find('.annotation-marker[series-name="' + this.name + '"]').show();
                                                        }
                                                    }
                                                }
                                            }
                                        ...
                                        if (is_annotation) {
                                            ...
                                            for (var i in chart_data) {
                                                ...
                                                (function (series) {
                                                    $http({
                                                        method: "GET", url: "/api/annotations/?series_name=" + series.name + '&type=' +
                                                            self.type + '&chart_name=102&project=' + self.project_live + '&center=' +
                                                            self.center_live + '&from=' + self.start_date + '&to=' + self.end_date + '&chart_type=bar'
                                                    }).success(function (annotations) {
                                                        annotations = _.sortBy(annotations.result, function (annotation) { return annotation.epoch });
                                                        $.each(annotations, function (j, annotation) {
                                                            ...
                                                            if (annotation.epoch) {
                                                                var a = new Annotation("102", $(self.chartOptions107.chart.renderTo),
                                                                    chart, point, annotation);
                                                                window.annotObj = a;
                                                                self.annot_perm();
                                                            }
                                ...
                                $('.widget-102a').removeClass('widget-loader-show');
                                $('.widget-102b').removeClass('widget-data-hide');
                            })

                        };

                        self.Test_Hourly_Error = function (final_work, type) {
                            if (type == undefined) {
                                type = 'day'
                            }
                            ...
                            self.type = type;
                            var hour_wise_error = '/api/hourly_error/' + self.data_to_show + type + final_work + '&chart_name=103';
                            return $http({ method: "GET", url: hour_wise_error }).success(function (result) {

                                var date_list = result.result.date;
                                var agent_prod_var = result.result.hourly_error;
                                var is_annotation = "false";
                                
                                if (self.list_object.test_error_for_hourly != undefined) {
                                    if (self.list_object.test_error_for_hourly.display_value === true) {
                                ...
                                if (self.list_object.test_error_for_hourly != undefined) {
                                    ...
                                    if (self.list_object.test_error_for_hourly.legends_align == 'bottom') {
                                    ...
                                    else if (self.list_object.test_error_for_hourly.legends_align == 'left') {
                                ...
                                angular.extend(self.chartOptions108, {
                                    xAxis: {
                                        categories: date_list,
                                    },
                                    legend: {
                                                ...
                                                events: {
                                                    contextmenu: function () {
                                                        if (self.role_for_perm == 'customer') {
                                                            ...
                                                            var str = '103<##>' + self.type + '<##>' + sub_proj + '<##>' + work_pack + '<##>' + sub_pack;
                                                            this['project'] = self.project_live;
                                                            this['center'] = self.center_live;
                                                            this['from'] = self.start_date;
                                                            this['to'] = self.end_date;
                                                            this['chart_type'] = 'bar';
                                                            return new Annotation(str, $(self.chartOptions108.chart.renderTo), this.series.chart, this);
                                                        }
                                                    }
                                                }
                                            },
                                            events: {
                                                hide: function () {
                                                    if (self.annotObj) {
                                                        if (self.annotObj.length > 0) {
                                                            window.annotObj.redraw(this.name, this.visible);
                                                            $(document).find('.widget-103a').find('.annotation-marker[series-name="' + this.name + '"]').hide();
                                                        }
                                                    }
                                                },
                                                show: function () {
                                                    if (self.annotObj) {
                                                        if (self.annotObj.length > 0) {
                                                            window.annotObj.redraw(this.name, this.visible);
                                                            $(document).find('.widget-103a').find('.annotation-marker[series-name="' + this.name + '"]').show();
                                                        }
                                                    }
                                                }
                                            }
                                        ...
                                        if (is_annotation) {
                                            ...
                                            for (var i in chart_data) {
                                                ...
                                                (function (series) {
                                                    $http({
                                                        method: "GET", url: "/api/annotations/?series_name=" + series.name + '&type=' +
                                                            self.type + '&chart_name=103&project=' + self.project_live + '&center=' +
                                                            self.center_live + '&from=' + self.start_date + '&to=' + self.end_date + '&chart_type=bar'
                                                    }).success(function (annotations) {
                                                        annotations = _.sortBy(annotations.result, function (annotation) { return annotation.epoch });
                                                        $.each(annotations, function (j, annotation) {
                                                            ...
                                                            if (annotation.epoch) {
                                                                var a = new Annotation("103", $(self.chartOptions108.chart.renderTo),
                                                                    chart, point, annotation);
                                                                window.annotObj = a;
                                                                self.annot_perm();
                                                            }
                                ...
                                $('.widget-103a').removeClass('widget-loader-show');
                                $('.widget-103b').removeClass('widget-data-hide');
                            })

                        };

                        self.Hourly_Accuracy = function (final_work, type) {
                            if (type == undefined) {
                                type = 'day'
                            }
                            ...
                            self.type = type;
                            var hour_accur = '/api/hourly_accu/' + self.data_to_show + type + final_work + '&chart_name=104';
                            return $http({ method: "GET", url: hour_accur }).success(function (result) {

                                var date_list = result.result.date;
                                var agent_prod_var = result.result.hour_acc;
                                var is_annotation = "false";
                                
                                if (self.list_object.hourly_accuracy != undefined) {
                                    if (self.list_object.hourly_accuracy.display_value === true) {
                                ...
                                if (self.list_object.hourly_accuracy != undefined) {
                                    ...
                                    if (self.list_object.hourly_accuracy.legends_align == 'bottom') {
                                    ...
                                    else if (self.list_object.hourly_accuracy.legends_align == 'left') {
                                ...
                                angular.extend(self.chartOptions109, {
                                    xAxis: {
                                        categories: date_list,
                                    },
                                    legend: {
                                                ...
                                                events: {
                                                    contextmenu: function () {
                                                        if (self.role_for_perm == 'customer') {
                                                            ...
                                                            var str = '104<##>' + self.type + '<##>' + sub_proj + '<##>' + work_pack + '<##>' + sub_pack;
                                                            this['project'] = self.project_live;
                                                            this['center'] = self.center_live;
                                                            this['from'] = self.start_date;
                                                            this['to'] = self.end_date;
                                                            this['chart_type'] = 'bar';
                                                            return new Annotation(str, $(self.chartOptions109.chart.renderTo), this.series.chart, this);
                                                        }
                                                    }
                                                }
                                            },
                                            events: {
                                                hide: function () {
                                                    if (self.annotObj) {
                                                        if (self.annotObj.length > 0) {
                                                            window.annotObj.redraw(this.name, this.visible);
                                                            $(document).find('.widget-104a').find('.annotation-marker[series-name="' + this.name + '"]').hide();
                                                        }
                                                    }
                                                },
                                                show: function () {
                                                    if (self.annotObj) {
                                                        if (self.annotObj.length > 0) {
                                                            window.annotObj.redraw(this.name, this.visible);
                                                            $(document).find('.widget-104a').find('.annotation-marker[series-name="' + this.name + '"]').show();
                                                        }
                                                    }
                                                }
                                            }
                                        ...
                                        if (is_annotation) {
                                            ...
                                            for (var i in chart_data) {
                                                ...
                                                (function (series) {
                                                    $http({
                                                        method: "GET", url: "/api/annotations/?series_name=" + series.name + '&type=' +
                                                            self.type + '&chart_name=104&project=' + self.project_live + '&center=' +
                                                            self.center_live + '&from=' + self.start_date + '&to=' + self.end_date + '&chart_type=bar'
                                                    }).success(function (annotations) {
                                                        annotations = _.sortBy(annotations.result, function (annotation) { return annotation.epoch });
                                                        $.each(annotations, function (j, annotation) {
                                                            ...
                                                            if (annotation.epoch) {
                                                                var a = new Annotation("104", $(self.chartOptions109.chart.renderTo),
                                                                    chart, point, annotation);
                                                                window.annotObj = a;
                                                                self.annot_perm();
                                                            }
                                ...
                                $('.widget-104a').removeClass('widget-loader-show');
                                $('.widget-104b').removeClass('widget-data-hide');
                            })
                        ...
                        if (self.is_voice_flag == false) {
                            ...
                            $.each(uniqueNames, function (key, val) {
                                if ((val == 'productivity_chart') || (val == 'productivity_bar_graph')) {
                                    ...
                                    self.Volume_Comparison_identity(undefined, undefined)
                                } else if (val == 'aht_comparison_id') {
                                    self.AHT_Comparison_id(undefined, undefined)
                                } else if (val == 'aht_comparison_identity') {
                                ...
                                } else if (val == 'external_error_count_widget') {
                                    self.Error_Count_Category(undefined, undefined)
                                } else if (val == 'production_vs_target') {
                                    self.Production_vs_target(undefined, undefined)
                                ...
                                }else if (val == 'head_count') {
                                    self.head_coun(undefined, undefined)
                                }else if (val == 'overall_head_count') {
                                ...
                                }else if (val == 'overall_external_error') {
                                    self.Ext_Err_Count(undefined, undefined)
                                }else if (val == 'overall_internal_accuracy') {
                                    self.Int_Acc_Trend(undefined, undefined)
                                }else if (val == 'tat_date') {
                                    self.Tat_Date_Wise(undefined, undefined)
                                }else if (val == 'agent_wise_production') {
                                    self.Agent_Wise_Production(undefined, undefined)
                                }else if (val == 'probe_overall_external_accuracy') {
                                    self.Probe_overall_ext_accracy(undefined, undefined)
                                }else if (val == 'internal_accuracy_agents_wise') {
                                    self.Agent_Wise_Internal_Accuracy(undefined, undefined)
                                }else if (val == 'external_accuracy_agents_wise') {
                                    self.Agent_Wise_External_Accuracy(undefined, undefined)
                                ...
                                } else if (val == 'test_widget_for_hourly') {
                                    self.Test_Widget_Hourly(undefined, undefined)
                                } else if (val == 'hourly_logins') {
                                    self.Test_Hourly_Login(undefined, undefined)
                                } else if (val == 'test_error_for_hourly') {
                                    self.Test_Hourly_Error(undefined, undefined)
                                } else if (val == 'hourly_accuracy') {
                                    self.Hourly_Accuracy(undefined, undefined)
                                } else if (val == 'static_hourly_total_error') {
                                    self.static_total_errors()
                                } else if (val == 'static_hourly_total_production') {
                                    self.static_total_production()
                                } else if (val == 'static_hourly_total_logins') {
                                    self.static_total_logins()
                                }
                            });

                            setInterval(function () {
                                if (self.start == self.end) {
                                    $http.get("api/datetime").then(function (data) {
                                        var stat_dt = data.data.result.result;
                                        if (stat_dt == self.start) {
                                            $.each(uniqueNames, function (key, val) {
                                                if (self.day_type == 'hour') {
                                                    if (val == 'test_widget_for_hourly') {
                                                        self.Test_Widget_Hourly(undefined, undefined)
                                                    } else if (val == 'hourly_logins') {
                                                        self.Test_Hourly_Login(undefined, undefined)
                                                    } else if (val == 'test_error_for_hourly') {
                    ...
                    self.packet_data = $http.get(self.pro_landing_url).then(function (result) {
                        ...
                        self.final_layout_values_list = {
                            ...
                            "self.chartOptions93": self.chartOptions93,
                            "self.chartOptions94": self.chartOptions94,
                            ...
                            "self.chartOptions99": self.chartOptions99,
                            "self.chartOptions100": self.chartOptions100,
                            ...
                            "self.chartOptions106": self.chartOptions106,
                            "self.chartOptions107": self.chartOptions107,
                            "self.chartOptions108": self.chartOptions108,
                            "self.chartOptions109": self.chartOptions109,
                        ...
                        self.chartProcess = function (result) {
                            ...
                            self.is_hourly_flag = result.data.result.is_hourly;
                        ...
                        self.dateType = function (key, all_data, name, button_clicked) {
                            ...
                            if (name == 'chartOptions85') {
                                $('.widget-80a').addClass('widget-loader-show');
                                $('.widget-80b').addClass('widget-data-hide');
                                self.Volume_Comparison_id(final_work, key);
                            }

                            if (name == 'chartOptions86') {
                                $('.widget-81a').addClass('widget-loader-show');
                                $('.widget-81b').addClass('widget-data-hide');
                                self.Volume_Comparison_identity(final_work, key);
                            }

                            if (name == 'chartOptions87') {
                                $('.widget-82a').addClass('widget-loader-show');
                                $('.widget-82b').addClass('widget-data-hide');
                                self.AHT_Comparison_id(final_work, key);
                            }

                            if (name == 'chartOptions88') {
                                $('.widget-83a').addClass('widget-loader-show');
                                $('.widget-83b').addClass('widget-data-hide');
                                self.AHT_Comparison_identity(final_work, key);
                            }
                            ...
                            if (name == 'chartOptions93') {
                                $('.widget-88a').addClass('widget-loader-show');
                                $('.widget-88b').addClass('widget-data-hide');
                                self.Error_Count_Category(final_work, key);
                            }

                            if (name == 'chartOptions94') {
                                $('.widget-89a').addClass('widget-loader-show');
                                $('.widget-89b').addClass('widget-data-hide');
                                self.head_coun(final_work, key);
                            }

                            
                            if (name == 'chartOptions95') {
                                $('.widget-90a').addClass('widget-loader-show');
                                $('.widget-90b').addClass('widget-data-hide');
                                self.Production_vs_target(final_work, key);
                            }


                            if (name == 'chartOptions96') {
                                $('.widget-91a').addClass('widget-loader-show');
                                $('.widget-91b').addClass('widget-data-hide');
                                self.Overall_Headcount(final_work, key);
                            }

                            if (name == 'chartOptions97') {
                                $('.widget-92a').addClass('widget-loader-show');
                                $('.widget-92b').addClass('widget-data-hide');
                            ...
                            if (name == 'chartOptions99') {
                                $('.widget-94a').addClass('widget-loader-show');
                                $('.widget-94b').addClass('widget-data-hide');
                                self.Ext_Err_Count(final_work, key);
                            }

                            if (name == 'chartOptions100') {
                                $('.widget-95a').addClass('widget-loader-show');
                                $('.widget-95b').addClass('widget-data-hide');
                                self.Int_Acc_Trend(final_work, key);
                            }

                            if (name == 'chartOptions101') {
                                $('.widget-96a').addClass('widget-loader-show');
                                $('.widget-96b').addClass('widget-data-hide');
                                self.Tat_Date_Wise(final_work, key);
                            }

                            if (name == 'chartOptions105') {
                                $('.widget-100a').addClass('widget-loader-show');
                                $('.widget-100b').addClass('widget-data-hide');
                                self.Probe_overall_ext_accracy(final_work, key);
                            }

                            if (name == 'chartOptions102') {
                                $('.widget-97a').addClass('widget-loader-show');
                                $('.widget-97b').addClass('widget-data-hide');
                                self.Agent_Wise_Internal_Accuracy(final_work, key);
                            }

                            if (name == 'chartOptions103') {
                                $('.widget-98a').addClass('widget-loader-show');
                                $('.widget-98b').addClass('widget-data-hide');
                                self.Agent_Wise_External_Accuracy(final_work, key);
                            }

                            if (name == 'chartOptions104') {
                                $('.widget-99a').addClass('widget-loader-show');
                                $('.widget-99b').addClass('widget-data-hide');
                                self.Agent_Wise_Production(final_work, key);
                            }

                            if (self.is_hourly_flag) {

                                if (name == 'chartOptions106') {
                                    $('.widget-101a').addClass('widget-loader-show');
                                    $('.widget-101b').addClass('widget-data-hide');
                                    self.Test_Widget_Hourly(final_work, key);
                                }

                                if (name == 'chartOptions107') {
                                    $('.widget-102a').addClass('widget-loader-show');
                                    $('.widget-102b').addClass('widget-data-hide');
                                    self.Test_Hourly_Login(final_work, key);
                                }

                                if (name == 'chartOptions108') {
                                    $('.widget-103a').addClass('widget-loader-show');
                                    $('.widget-103b').addClass('widget-data-hide');
                                    self.Test_Hourly_Error(final_work, key);
                                }

                                if (name == 'chartOptions109') {
                                    $('.widget-104a').addClass('widget-loader-show');
                                    $('.widget-104b').addClass('widget-data-hide');
                                    self.Hourly_Accuracy(final_work, key);
                                }
