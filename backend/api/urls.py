...
urlpatterns = [
    ...
    url(r'^cate_error_jumio/', apiviews.external_error_jum),
    ...
    url(r'^ivr_valid_cust_approv_id/', apiviews.valid_customer_approved_id),
    url(r'^ivr_invalid_cust_rejec_id/', apiviews.invalid_customer_reject_id),
    url(r'^ivr_valid_cust_approv_iden/', apiviews.valid_customer_approved_iden),
    url(r'^ivr_invalid_cust_rejec_iden/', apiviews.invalid_customer_reject_iden),
    ...
    url(r'^external_acc_trn',apiviews.Overall_external_accur),
