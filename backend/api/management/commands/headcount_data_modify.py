...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
	    ...
	    proje_cent = ['Probe','NTT DATA Services TP','NTT DATA Services Coding','Federal Bank','Ujjivan','Gooru',\
                  ...
                  'IBM Quality Control','IBM India and Sri Lanka','IBM NA and EU','IBM Arabia','IBM Latin America',\
                  'IBM Sri Lanka P2P','Mobius', 'Walmart Chittor','Jumio']
            ...
            for pro_cen in proje_cent:
                ...
                if date_li:
                    ...
                    volumes = RawTable.objects.filter(\
                                               project=prj_id, center=center_id, date__range=[date_li[0],date_li[-1]])\
