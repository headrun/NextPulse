        ...
        for month_name,month_dates in months_dict.iteritems():
            ...
            for pro_cen in proje_cent:
                ...
                if center_name == 'Salem':    
                    ...
                    billa_sum = sum(billa_sal)/prj_len
                    buffer_sum = sum(buf_sal)/prj_len
                    others_sum = sum(others_sal)/prj_len
                    total_sum = sum(total_sal)/prj_len
                else:
                    ...
                    billa_sum = sum(billa_chi)/prj_len
                    buffer_sum = sum(buf_chi)/prj_len
                    others_sum = sum(others_chi)/prj_len
                    total_sum = sum(total_chi)/prj_len
                ...
                for key,value in final_dict.iteritems():
                    ...
                    if key == 'center_others':
                        redis_key = '{0}_{1}_center_others'.format(center_name,month_name)
